...
# Add the items 1138 and ‘20 meters’ to the the list - the number at the start and the 
# string at the end. Print the updated list to confirm the changes.
...
listprint = "The list {0} contains {1} items."

print(listprint.format(cargo_hold, len(cargo_hold)))